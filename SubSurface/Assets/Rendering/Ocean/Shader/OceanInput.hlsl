...
{
    half2 wave01UV = (float2(_Time * .025, _Time * 0.75) * 0.2 + staticUV) * 5;
    half2 wave02UV = (float2(-_Time * 0.25, -_Time * 0.75) * 0.2 + staticUV) * 4;
    half2 wave03UV = (float2(-_Time * 0.025, _Time * 0.125) * 0.2 + staticUV) * 2;
